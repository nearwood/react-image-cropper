...
var Cropper = React.createClass({
    ...
    initStyles: function initStyles() {
        ...
        var newState = { img_width: container.offsetWidth };
        ...
        this.setState({
            ...
            var _props2 = _this.props,
                ...
                imgSize = _props2.imgSize;
            var selectionNatural = _this.state.selectionNatural;

            var img_width = imgSize && imgSize.img_width ? imgSize.img_width : _this.state.img_width;
            var img_height = imgSize && imgSize.img_height ? imgSize.img_height : _this.state.img_height;

            var frameWidth = _this.state.frameWidth ? _this.state.frameWidth : img_width;
            var frameHeight = _this.state.frameHeight ? _this.state.frameHeight : img_height / 4;
            if (selectionNatural) {
            ...
            if (_this.state.img_width !== img_width || _this.state.img_height != img_height) {
                _this.setState({ img_width: img_width, img_height: img_height });
            }
            _this.setState({ maxLeft: maxLeft, maxTop: maxTop, img_height: img_height });
            // calc clone position
    ...
    handleDragStop: function handleDragStop(e) {
        if (this.state.dragging) {
            ...
            var _state4 = this.state,
                img_width = _state4.img_width,
                img_height = _state4.img_height,
                onDragStop = _state4.onDragStop;
    ...
    componentWillReceiveProps: function componentWillReceiveProps(newProps) {
        ...
        } else if (typeof newProps.imgSize !== 'undefined' && typeof newProps.imgSize.img_width !== 'undefined' && typeof newProps.imgSize.img_height !== 'undefined' && (this.state.img_width !== newProps.imgSize.img_width || this.state.img_height !== newProps.imgSize.img_height)) {
            this.initStyles();
        }
    },
    ...
    values: function values() {
        var _state7 = this.state,
            ...
            img_height = _state7.img_height,
            selectionNatural = _state7.selectionNatural,
            moved = _state7.moved,
            originalOriginX = _state7.originalOriginX,
            originalOriginY = _state7.originalOriginY,
            originalFrameWidth = _state7.originalFrameWidth,
            originalFrameHeight = _state7.originalFrameHeight;
    ...
    render: function render() {
        var _state8 = this.state,
            dragging = _state8.dragging,
            img_height = _state8.img_height,
            img_width = _state8.img_width,
            imgBeforeLoaded = _state8.imgBeforeLoaded;
            ...
            imgBeforeLoaded ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement('img', { ref: 'cloneImg', width: img_width, height: img_height, crossOrigin: 'anonymous', src: src,
