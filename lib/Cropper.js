...
var Cropper = React.createClass({
    ...
    initStyles: function initStyles() {
        ...
        if (selectionNatural) {
            var realWidth = parseInt(frameWidth / scale);
            var realHeight = parseInt(frameHeight / scale);
            var realX = parseInt(originX / scale);
            var realY = parseInt(originY / scale);
        ...
        this.setState({ maxLeft: maxLeft, maxTop: maxTop });
    ...
    render: function render() {
        ...
        var imageNode = React.createElement(
            ...
            React.createElement('img', (_React$createElement = { width: imageWidth, height: imageHeight,
            ...
            }, _defineProperty(_React$createElement, 'width', imageWidth), _defineProperty(_React$createElement, 'height', imageHeight), _React$createElement))
        );
