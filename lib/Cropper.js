...
var Cropper = React.createClass({
    ...
    initStyles: function initStyles(skipScaling) {
        var _this = this;
        ...
        this.setState({ frameWidth: frameWidth, frameHeight: frameHeight, maxLeft: maxLeft, maxTop: maxTop, originX: originX, originY: originY }, function () {
