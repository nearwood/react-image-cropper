...
var Cropper = React.createClass({
    ...
    initStyles: function initStyles() {
        ...
        var frameWidth = this.state.frameWidth ? this.state.frameWidth : img_width;
        var frameHeight = this.state.frameHeight ? this.state.frameHeight : img_height / 4;
        if (selectionNatural) {
    ...
    handleDragStart: function handleDragStart(e) {
        ...
        if (!action && allowNewSelection) {
            ...
            this.setState({
                ...
                _this2.calcPosition(2, 2, pageX - offsetLeft, pageY - offsetTop);
            });
        }
    },
