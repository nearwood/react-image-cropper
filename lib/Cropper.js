...
var Cropper = React.createClass({
    ...
    render: function render() {
        ...
        var node = null;
        var disabledCursor = disabled ? { cursor: 'initial' } : {};
        ...
        node = React.createElement(
            ...
            imgBeforeLoaded ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('span', { style: deepExtend({}, this.state.styles.move, disabledCursor), 'data-action': 'move' }),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotCenter, disabledCursor), 'data-action': 'move' },
                    ...
                    React.createElement(
                        ...
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerNE, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotN), 'data-action': 'n' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerN, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotNW), 'data-action': 'nw' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerNW, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotE), 'data-action': 'e' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerE, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotW), 'data-action': 'w' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerW, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotSE), 'data-action': 'se' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerSE, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotS), 'data-action': 's' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerS, disabledCursor) })
                    ),
                    React.createElement(
                        'span',
                        { style: deepExtend({}, this.state.styles.dot, this.state.styles.dotSW), 'data-action': 'sw' },
                        React.createElement('span', { style: deepExtend({}, this.state.styles.dotInner, this.state.styles.dotInnerSW, disabledCursor) })
                    ),
                    React.createElement('span', { style: deepExtend({}, this.state.styles.line, this.state.styles.lineN, disabledCursor), 'data-action': 'n' }),
                    React.createElement('span', { style: deepExtend({}, this.state.styles.line, this.state.styles.lineS, disabledCursor), 'data-action': 's' }),
                    React.createElement('span', { style: deepExtend({}, this.state.styles.line, this.state.styles.lineW, disabledCursor), 'data-action': 'w' }),
                    React.createElement('span', { style: deepExtend({}, this.state.styles.line, this.state.styles.lineE, disabledCursor), 'data-action': 'e' })
                )
            ) : null
        );
        //}
