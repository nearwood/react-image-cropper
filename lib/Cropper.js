...
var Cropper = function (_React$Component) {
    ...
    function Cropper(props) {
        ...
        _this.state = {
            ...
            startX: 0,
            startY: 0,
            frameWidth: width || defaultWidth,
            fixedRatio: fixedRatio == undefined ? true : fixedRatio,
            selectionNatural: selectionNatural == undefined ? false : selectionNatural,
            allowNewSelection: allowNewSelection == undefined ? true : allowNewSelection,
            ...
            action: null,
            isImageLoaded: false,
            imageLoaded: imageLoaded || function () {},
            imageBeforeLoaded: false,
            beforeImageLoaded: beforeImageLoaded || function () {},
            styles: (0, _deepExtend2.default)({}, defaultStyles, styles),
            moved: false,
            originalOriginX: originX,
            originalOriginY: originY,
            originalFrameWidth: width || defaultWidth,
            originalFrameHeight: fixedRatio ? (width || defaultWidth) / rate : height || defaultHeight
        };
    ...
    _createClass(Cropper, [{
        ...
        value: function initStyles() {
            ...
            var container = _reactDom2.default.findDOMNode(this.container);
            this.setState({
                ...
                if (selectionNatural) {
                    var img = _reactDom2.default.findDOMNode(_this2.img);
                    ...
                    _this2.setState({ frameWidth: frameWidth, frameHeight: frameHeight, originX: originX, originY: originY });
                }
                ...
                // calc clone position
                _this2.calcPosition(frameWidth, frameHeight, originX, originY);
            });
        }
    }, {
        key: 'updateFrame',
        ...
        value: function imgGetSizeBeforeLoad() {
            var that = this;
            setTimeout(function () {
                var img = _reactDom2.default.findDOMNode(that.img);
        ...
        value: function handleDragStart(e) {
            ...
            if (!action && allowNewSelection) {
                ...
                this.setState({
                    ...
                    _this4.calcPosition(2, 2, pageX - offsetLeft, pageY - offsetTop);
                });
            }
        }
    }, {
        ...
        value: function handleDragStop(e) {
            if (this.state.dragging) {
                e.preventDefault();
                var frameNode = _reactDom2.default.findDOMNode(this.frameNode);
        ...
        value: function crop() {
            ...
            var img = _reactDom2.default.findDOMNode(this.img);
        ...
        value: function render() {
            ...
            var _state10 = this.state,
                ...
                imageBeforeLoaded = _state10.imageBeforeLoaded;
            ...
            var imageNode = _react2.default.createElement(
                'div',
                { style: this.state.styles.source, ref: function ref(_ref2) {
                        return _this5.sourceNode = _ref2;
                    } },
            ...
            return _react2.default.createElement(
                ...
                imageNode,
                imageBeforeLoaded ? _react2.default.createElement(
                    'div',
                    null,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', {
                                crossOrigin: 'anonymous',
                                src: src,
                                style: (0, _deepExtend2.default)({}, this.state.styles.img, {
...
Cropper.propTypes = {
    ...
    //imageLoaded: PropTypes.function,
    //beforeImageLoaded: PropTypes.function
};
